...
class LibroSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('libro')->insert([
            ...
            ",
            'precio' => 15.00,
            'foto' => "Img\FotosLibros\libro1.jpg",
            'categoria_id' => 1,
            'autor_id' => 5
        ]);

        DB::table('libro')->insert([
            'titulo' => "El día que él volvió",
            'sinopsis' => "Aquel fue el verano de mi vida.
            ...
            ",
            'precio' => 16.00,
            'foto' => "Img\FotosLibros\libro2.jpg",
            'categoria_id' => 1,
            'autor_id' => 2
        ]);
        ...
        DB::table('libro')->insert([
            ...
            'precio' => 18.95,
            'foto' => "Img\FotosLibros\libro3.jpg",
            'categoria_id' => 1,
            'autor_id' => 7
        ]);
        ...
        DB::table('libro')->insert([
            ...
            'precio' => 16.50,
            'foto' => "Img\FotosLibros\libro4.jpg",
            'categoria_id' => 4,
            'autor_id' => 5
        ]);

        DB::table('libro')->insert([
            'titulo' => "Cómo casarse con un marqués",
            'sinopsis' => "La desesperación de Elizabeth Hotchkiss por conseguir un marido rico parece llegar a su fin cuando tropieza con una copia de Cómo casarse con un marques en la biblioteca de lady Danbury, para quien trabaja. Se trata de una tentadora guía de seducción que explica justo lo que la joven necesita: cómo casarse con un hombre acaudalado. Ya que, en la Inglaterra de 1815 no existen demasiadas opciones para una muchacha sin bienes familiares que, además, tiene tres hermanos menores a los que mantener.
            ...
            ",
            'precio' => 16.50,
            'foto' => "Img\FotosLibros\libro5.jpg",
            'categoria_id' => 1,
            'autor_id' => 5
        ]);
        ...
        DB::table('libro')->insert([
            ...
            ",
            'precio' => 19.00,
            'foto' => "Img\FotosLibros\libro9.jpg",
            'categoria_id' => 2,
            'autor_id' => 3
        ]);
        ...
        DB::table('libro')->insert([
            ...
            ",
            'precio' => 16.50,
            'foto' => "Img\FotosLibros\libro10.jpg",
            'categoria_id' => 1,
            'autor_id' => 1
        ]);
        ...
        DB::table('libro')->insert([
            ...
            ",
            'precio' => 19.00,
            'foto' => "Img\FotosLibros\libro11.jpg",
            'categoria_id' => 1,
            'autor_id' => 4
        ]);
    }
