        ...
        <div class="Slider__Box">
            <?php for($i=1; $i <= 5; $i++): ?>
                <div class="Slider__Box__Item">
                    <a href="/view/<?php echo e($libro[$i]->titulo); ?>"><img src="/Img/Slider/Slider<?php echo e($i); ?>.png"/></a> <!--Recoger el enlace del slider-->
                </div>
            <?php endfor; ?>
        </div>
    ...
    <div class="Novedades">
        ...
        <div class="Novedades__BoxLibros">
            ...
            <div class="Novedades__BoxLibros__Libro">
                ...
                <a class="Novedades__BoxLibros__Libro__Titulo" href="/view/<?php echo e($libro[$i]->titulo); ?>"><?php echo e($libro[$i]->titulo); ?></a>
                <a class="Novedades__BoxLibros__Libro__Autor" href="/search/<?php echo e($libro[$i]->autor->nombre); ?>"><?php echo e($libro[$i]->autor->nombre); ?></a>
...
<?php echo $__env->make('layout/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TheNextBookBack\resources\views/home.blade.php ENDPATH**/ ?>